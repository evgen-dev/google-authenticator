...
class FixedBitNotation
{
     ...
     * @param string|null $chars Base character alphabet
    ...
    public function __construct(
        int  $bitsPerCharacter, ?string $chars = NULL, bool $rightPadFinalBits = FALSE,
        bool $padFinalGroup = FALSE, string $padCharacter = '=')
    {
